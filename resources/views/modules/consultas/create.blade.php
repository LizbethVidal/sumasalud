            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('consultas.store')}}">
                        ...
                        <input type="hidden" name="tratamiento_id" id="tratamiento_id" value="">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex justify-content-start gap-3">
                                    <div>
                                        <label for="tratamiento_text">Tratamiento asignado</label>
                                        <input type="text" name="tratamiento_text" id="tratamiento_text" class="form-control" readonly>
                                    </div>
                                    <div class="d-flex align-items-end">
                                        <button type="button" class="btn btn-warning d-none" onclick="$('#tratamiento_id').val('');$('#tratamiento_text').val('');$('#reset_tratamiento').addClass('d-none');" id="reset_tratamiento">Quitar tratamiento</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <label for="observaciones_paciente">Motivo de la consulta</label>
                                <textarea name="observaciones_paciente" id="observaciones_paciente" class="form-control @if($errors->has('observaciones_paciente')) is-invalid @endif" required>{{old('observaciones_paciente')}}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="diagnostico" id="diagnostico" class="form-control @if($errors->has('diagnostico')) is-invalid @endif" required>{{old('diagnostico')}}</textarea>
